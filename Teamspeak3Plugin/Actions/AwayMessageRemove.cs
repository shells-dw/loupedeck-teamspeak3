namespace Loupedeck.Teamspeak3Plugin.Actions
{
    ...
    internal class AwayMessageRemove : PluginDynamicCommand
    {
        ...
        protected override Boolean OnLoad()
        {
            ...
            if (l7dValues != null)
            {
                this.AddParameter("awaymessageremove", l7dValues["displayName"], l7dValues["groupName"]);
            }
            else
            {
                this._plugin.Log.Info($"awaymessageremove : l7dValues was empty or null: DisplayName: {l7dValues["displayName"]}, groupName: {l7dValues["groupName"]}.");
            }
            return !(this._plugin is null) && base.OnLoad();
        }
        protected override void RunCommand(String actionParameter)
        {
            Helper.TS3Handler.SetAwayMessage("");
        ...
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
            using (var bitmapBuilder = new BitmapBuilder(imageSize))
            {
                ...
                if (!String.IsNullOrEmpty(actionParameter))
                {
                    ...
                    var y1 = bitmapBuilder.Height * 0.53;
                    if (!this._plugin.tsConnected)
                    {
                        y1 = bitmapBuilder.Height * 0.69;
                    }
                    var h = bitmapBuilder.Height * 0.3;
                    bitmapBuilder.SetBackgroundImage(this._plugin.tsConnected ? EmbeddedResources.ReadImage(EmbeddedResources.FindFile("awayMessageOff.png")) : EmbeddedResources.ReadImage(EmbeddedResources.FindFile("notConnected.png")));
                    bitmapBuilder.DrawText(this._plugin.tsConnected ? this._l10n.GetL7dMessage("removeAwayMessage") : this._l10n.GetL7dMessage("notConnected"), (Int32)x1, (Int32)y1, (Int32)w, (Int32)h, new BitmapColor(255, 255, 255), imageSize == PluginImageSize.Width90 ? 15 : 12, imageSize == PluginImageSize.Width90 ? 2 : 0, 10);
                }
